...
class NotificationManager{
    ...
    static func scheduleSnoozedNotification(forInjection injection: Injection, snoozedUntil: Date, originalDateDue: Date, queueObject: Queue){
        ...
        let content = UNMutableNotificationContent()
        content.title = "Injection Time!"
        content.body = "It's time for your injection \(injection.name!) of \(injection.dosage!) \(injection.units!), that was originally due \(originalDateDue.fullDateTime) and snoozed until \(snoozedUntil.prettyTime)."
